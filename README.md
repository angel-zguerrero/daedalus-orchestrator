...
go run -tags rocksdb . -self-member-host 127.0.0.1 -cluster-base-port 5000 -initial-members=127.0.0.1:5001,127.0.0.1:5002,127.0.0.1:5003 -replica 1 -admin-port 45001 -master-db-engine=rocksdb
go run . -self-member-host 127.0.0.1 -cluster-base-port 5000 -initial-members=127.0.0.1:5001,127.0.0.1:5002,127.0.0.1:5003 -replica 2  -admin-port 45002
go run -tags rocksdb . -self-member-host 127.0.0.1 -cluster-base-port 5000 -initial-members=127.0.0.1:5001,127.0.0.1:5002,127.0.0.1:5003 -replica 3  -admin-port 45003 -master-db-engine pebble
