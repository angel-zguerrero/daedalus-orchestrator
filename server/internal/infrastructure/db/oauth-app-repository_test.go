...
func TestCreateOAuthApp_Success(t *testing.T) {
	...
	// Exists check for unique indexes and primary data
	mockStore.On("Exists", db.AdminFC, db.AdminFCSector, "admin_schema:oauth_apps:data:app123", mock.Anything).Return(false, nil)
