...
const (
	...
	JobWorkerService_BulkAckMessages_FullMethodName = "/jobworker.JobWorkerService/BulkAckMessages"
)
...
type JobWorkerServiceClient interface {
	...
	BulkAckMessages(ctx context.Context, in *BulkAckMessageRequest, opts ...grpc.CallOption) (*AckMessageResponse, error)
}
...
func (c *jobWorkerServiceClient) BulkAckMessages(ctx context.Context, in *BulkAckMessageRequest, opts ...grpc.CallOption) (*AckMessageResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AckMessageResponse)
	err := c.cc.Invoke(ctx, JobWorkerService_BulkAckMessages_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type JobWorkerServiceServer interface {
	...
	BulkAckMessages(context.Context, *BulkAckMessageRequest) (*AckMessageResponse, error)
...
func (UnimplementedJobWorkerServiceServer) BulkAckMessages(context.Context, *BulkAckMessageRequest) (*AckMessageResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method BulkAckMessages not implemented")
}
...
func _JobWorkerService_BulkAckMessages_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BulkAckMessageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(JobWorkerServiceServer).BulkAckMessages(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: JobWorkerService_BulkAckMessages_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(JobWorkerServiceServer).BulkAckMessages(ctx, req.(*BulkAckMessageRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var JobWorkerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BulkAckMessages",
			Handler:    _JobWorkerService_BulkAckMessages_Handler,
		},
	},
