...
func (r *MasterKVBaseRocksDBStateMachine) Lookup(rocks_kv_store *db.RocksdbStore, lookupQuery LookupQuery) (interface{}, error) {
	return rocks_kv_store.Get(lookupQuery.ColumnFamilyName, lookupQuery.Key)
}

func (r *MasterKVBaseRocksDBStateMachine) Update(rocks_kv_store *db.RocksdbStore, ents []statemachine.Entry, batch *grocksdb.WriteBatch) ([]statemachine.Entry, error) {
